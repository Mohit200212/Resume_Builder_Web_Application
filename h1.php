                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-center">
                    ...
                    <!-- <li class="nav-item dropdown" id="templates"> -->
                        ...
                        <li class="nav-item dropdown" id="user">
                            <?php if ($username) : ?>
                                <a class="nav-link dropdown-toggle text-white nav_hover" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <?php echo $username; ?>
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="userDropdown">
                                    <li><a class="dropdown-item" href="h3.php">Logout</a></li>
                                </ul>
                            <?php else : ?>
                                <a class="nav-link dropdown-toggle text-white nav_hover" href="l.php">Login</a>
                            <?php endif; ?>
                        </li>
